        ...
        <div className="movieList">
            ...
            <header>
                ...
                <div className="searchbar">
                    ...
                    <input type="text" placeholder='search something here' onKeyPress={(e) => e.key === 'Enter' && (e.target.value === "osterei" || "Osterei" ? routeChange() : (e.target.value === "" ? setDefaultScreen(true) : setSearchValue(e.target.value)))} />
                </div>
